...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/12/2018','dd/mm/yy') AND 
...
WHERE
    ...
    --não julgado até o mês de referência
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            ...
            TO_DATE('31/12/2018','dd/mm/yy')    --vai ficar mudando
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
              FROM eg.EGT_REMESSA_LOTE rem
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('31/12/2018','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
...
WHERE
    ...
    --AND proc.ANO_PROC <=2016
    --AND classe.NUM_CLASSE_CNJ IN (63,65,74,119,980)
    AND processo.NUM_ITEM IN (39, 40, 41, 42, 43, 44, 46, 47, 48,49, 90039, 90040, 90041, 90042, 90043, 90044, 90046, 90047, 90048,90049)
    )
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('31/01/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('28/02/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('31/03/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('30/04/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('31/05/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('30/06/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('31/07/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
              FROM eg.EGT_REMESSA_LOTE rem
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/08/1800','dd/mm/yy') AND 
            TO_DATE('31/08/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('30/09/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('31/10/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
...
INNER JOIN (SELECT rem.NUM_REMESSA, max(rem.NUM_LOTE) NUM_LOTE
        ...
        WHERE rem.DTA_INICIO_PERIODO_REFERENCIA BETWEEN 
            TO_DATE('01/01/1800','dd/mm/yy') AND 
            TO_DATE('30/11/2019','dd/mm/yy')    --vai ficar mudando
            --não ter sido julgado até o mês de referência
GROUP BY rem.NUM_REMESSA) x ON processo.NUM_REMESSA=x.NUM_REMESSA AND processo.NUM_LOTE=x.NUM_LOTE
LEFT JOIN eg.EGT_REMESSA_LOTE remessa ON (remessa.NUM_TRIBUNAL = PROCESSO.NUM_TRIBUNAL AND 
												remessa.NUM_ORGAO_ESTATISTICA = PROCESSO.NUM_ORGAO_ESTATISTICA AND
