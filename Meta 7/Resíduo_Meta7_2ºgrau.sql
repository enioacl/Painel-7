...
WHERE detalhe.ID_SOLICITACAO_ESTATISTICAS IN (12124)  AND parametro.ID_PARAMETRO=2 --pra buscar somente as linhas com "data final"
...
WHERE detalhe.ID_SOLICITACAO_ESTATISTICAS IN (12124,12128,12129,12303)  AND parametro.ID_PARAMETRO=2 --pra buscar somente as linhas com "data final"
ORDER BY quantidade.ID_SOLICITACAO_ESTATISTICAS, quantidade.ID_RESULT_ESTAT_QUANT, detalhe.ID_RESULT_ESTAT_DET) saida
