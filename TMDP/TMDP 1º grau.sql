-- Meta 5 - Tempo médio de duração do processo 1º Grau - TMDP1c
...
AND REM.COD_SITUACAO_REMESSA = 'G'
	    --TO_DATE((select ADD_MONTHS(trunc(sysdate,'mm'), -1) from dual),'dd/mm/yy') AND 
...
WHERE
	...
	AND processo.NUM_ITEM IN (416,90416) --talvez o 416?
) saida
